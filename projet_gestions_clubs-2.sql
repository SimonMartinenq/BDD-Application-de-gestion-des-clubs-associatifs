...
insert into etat (id_etat, libelle, Date_debut, Date_fin) values
   (1,'en cours de création','2021-01-11', '2021-02-05'),
   (2,'en cours de création','2020-01-20', '2020-03-26'),
   (3,'en attente de signature','2020-08-23', '2020-09-28'),
   (4,'en attente de signature','2020-06-19', '2020-07-04'),
   (5,'signé','2020-05-01', '2020-05-27'), 
   (6,'soumis','2020-06-11', '2020-09-29'), 
   (7,'signé','2020-09-01', '2020-10-12'), 
   (8,'signé','2020-02-18', '2020-06-16'), 
   (9,'soumis','2020-07-11', '2020-08-12'),
   (10,'soumis','2020-06-01', '2021-07-03'), 
   (11,'en attente de signature','2020-06-09', '2020-07-13'),
   (12,'en attente de signature','2020-05-12', '2020-06-26'),
   (13,'absent','2021-01-02', '2021-01-11'),
   (14,'en attente de signature','2020-03-28', '2020-05-04'),
   (15,'en attente de signature','2021-02-25', '2021-04-27'),
   (16,'en attente de signature','2021-02-03', '2021-05-12'),
   (17,'en attente de signature','2020-03-09', '2020-04-11'),
   (18,'en attente de signature','2020-01-14', '2020-03-28'),
   (19,'en attente de signature','2020-03-15', '2020-04-12'),
   (20,'en attente de signature','2020-02-07', '2020-03-25'),
